...
// isLevel: 레벨/하트 기반 게임
// goalDefault: 목표 점수 기본값 (game_common.js initGoalBar)
...
const GAMES=[
  ...
  {id:'pattern',   name:'패턴 완성',      cat:'논리',  desc:'규칙을 찾으세요',          color:'#EF4444',unlockXp:0, isTimer:true,  isLevel:false, goalDefault:100, missionDefault:110},
  {id:'focus',     name:'집중력 탭',      cat:'반응',  desc:'타겟만 빠르게',            color:'#14B8A6',unlockXp:0, isTimer:true,  isLevel:false, goalDefault:150, missionDefault:170},
  {id:'rotate',    name:'도형 회전',      cat:'공간',  desc:'같은 도형 찾기',           color:'#8B5CF6',unlockXp:0, isTimer:true,  isLevel:false, goalDefault:70,  missionDefault:90},
  {id:'reverse',   name:'순서 뒤집기',    cat:'유연성',desc:'거꾸로 기억하기',          color:'#F97316',unlockXp:0, isTimer:false, isLevel:true,  goalDefault:60,  missionDefault:80},
  {id:'numtouch',  name:'넘버 터치',      cat:'반응',  desc:'1~25 순서대로 터치',       color:'#0EA5E9',unlockXp:0, isTimer:false, isLevel:false, goalDefault:80,  missionDefault:100},
  {id:'rhythm',    name:'리듬 기억',      cat:'기억력',desc:'박자 패턴 따라하기',       color:'#D946EF',unlockXp:0, isTimer:false, isLevel:true,  goalDefault:80,  missionDefault:90},
  {id:'rps',       name:'두뇌 가위바위보',cat:'유연성',desc:'조건에 맞게 선택',         color:'#F43F5E',unlockXp:0, isTimer:true,  isLevel:false, goalDefault:120, missionDefault:130},
  {id:'oddone',    name:'다른 글자 찾기', cat:'반응',  desc:'다른 글자 하나를 찾으세요', color:'#06B6D4',unlockXp:0, isTimer:true,  isLevel:false, goalDefault:170, missionDefault:190},
  {id:'compare',   name:'크다작다',       cat:'연산',  desc:'빠른 수 비교 판단',        color:'#84CC16',unlockXp:0, isTimer:true,  isLevel:false, goalDefault:140, missionDefault:150},
  {id:'bulb',      name:'전구 기억',      cat:'기억력',desc:'켜지는 순서 기억',         color:'#FBBF24',unlockXp:0, isTimer:false, isLevel:true,  goalDefault:80,  missionDefault:90},
  {id:'colormix',  name:'색깔 조합',      cat:'논리',  desc:'색 혼합 결과 맞추기',      color:'#A855F7',unlockXp:0, isTimer:true,  isLevel:false, goalDefault:70,  missionDefault:90},
  {id:'wordcomp',  name:'단어 완성',      cat:'언어',  desc:'빈칸 글자 맞추기',         color:'#22D3EE',unlockXp:0, isTimer:true,  isLevel:false, goalDefault:90,  missionDefault:110},
  {id:'timing',    name:'타이밍',         cat:'반응',  desc:'정확한 타이밍에 멈추기',   color:'#FB923C',unlockXp:0, isTimer:false, isLevel:false, goalDefault:70,  missionDefault:90},
  {id:'matchpair', name:'짝 맞추기',      cat:'언어',  desc:'한자어와 뜻 연결',         color:'#4ADE80',unlockXp:0, isTimer:true,  isLevel:false, goalDefault:150, missionDefault:170},
  {id:'headcount', name:'인원 세기',      cat:'집중',  desc:'몇 명이 남았을까?',        color:'#F87171',unlockXp:0, isTimer:true,  isLevel:true,  goalDefault:70,  missionDefault:90},
  {id:'pyramid',   name:'피라미드 연산',  cat:'연산',  desc:'합으로 피라미드 완성',     color:'#FB923C',unlockXp:0, isTimer:true,  isLevel:false, goalDefault:60,  missionDefault:70},
  {id:'maxnum',    name:'수 찾기',        cat:'집중',  desc:'가장 큰/작은 수를 터치',   color:'#38BDF8',unlockXp:0, isTimer:true,  isLevel:false, goalDefault:130, missionDefault:150},
  {id:'signfind',  name:'부호 찾기',      cat:'연산',  desc:'빠진 연산자 맞추기',       color:'#A78BFA',unlockXp:0, isTimer:true,  isLevel:false, goalDefault:90,  missionDefault:110},
  {id:'coincount', name:'동전 세기',      cat:'연산',  desc:'동전 총액 빠르게 계산',    color:'#FCD34D',unlockXp:0, isTimer:true,  isLevel:false, goalDefault:70,  missionDefault:90},
  {id:'clock',     name:'시계 읽기',      cat:'반응',  desc:'아날로그 시계 읽기',       color:'#2DD4BF',unlockXp:0, isTimer:true,  isLevel:false, goalDefault:60,  missionDefault:70},
  {id:'wordmem',   name:'단어 암기',      cat:'기억력',desc:'단어 외우고 기억하기',     color:'#C084FC',unlockXp:0, isTimer:false, isLevel:true,  goalDefault:70,  missionDefault:90},
  {id:'blockcount',name:'블록 세기',      cat:'공간',  desc:'쌓인 블록 개수 세기',      color:'#64748B',unlockXp:0, isTimer:true,  isLevel:false, goalDefault:70,  missionDefault:90},
  {id:'flanker',   name:'방향 맞추기',    cat:'반응',  desc:'가운데 화살표 방향은?',    color:'#6366F1',unlockXp:0, isTimer:true,  isLevel:false, goalDefault:120, missionDefault:130},
  {id:'memgrid',   name:'격자 기억',      cat:'기억력',desc:'켜진 칸을 기억하세요',     color:'#F472B6',unlockXp:0, isTimer:false, isLevel:true,  goalDefault:60,  missionDefault:80},
  {id:'nback',     name:'같거나 다르거나',cat:'집중',  desc:'이전과 같은지 순간 판단',  color:'#34D399',unlockXp:0, isTimer:true,  isLevel:false, goalDefault:80,  missionDefault:100},
  {id:'scramble',  name:'글자 섞기',      cat:'언어',  desc:'섞인 글자로 단어 만들기',  color:'#FB7185',unlockXp:0, isTimer:false, isLevel:false, goalDefault:70,  missionDefault:90},
  {id:'serial',    name:'연속 빼기',      cat:'연산',  desc:'계속 빼 나가세요',         color:'#818CF8',unlockXp:0, isTimer:true,  isLevel:false, goalDefault:100, missionDefault:110},
  {id:'leftright', name:'좌우 판단',      cat:'유연성',desc:'왼손? 오른손?',            color:'#F9A8D4',unlockXp:0, isTimer:true,  isLevel:false, goalDefault:120, missionDefault:130},
  {id:'calccomp',  name:'계산 비교',      cat:'연산',  desc:'어느 식이 더 큰가',        color:'#FBBF24',unlockXp:0, isTimer:true,  isLevel:false, goalDefault:90,  missionDefault:110},
  {id:'flash',     name:'순간 포착',      cat:'기억력',desc:'잠깐 보고 기억하기',       color:'#F59E0B',unlockXp:0, isTimer:false, isLevel:true,  goalDefault:70,  missionDefault:90},
  {id:'sort',      name:'카테고리 분류',  cat:'반응',  desc:'빠르게 분류하세요',        color:'#2DD4BF',unlockXp:0, isTimer:true,  isLevel:false, goalDefault:120, missionDefault:130},

...
function wcPick(el,picked,answer,full){if(wcQTime<=0)return;if(el.classList.contains('ok')||el.classList.contains('no'))return;clearInterval(wcQTimer);freezeQBar('wc-qbar');wcTotal++;
